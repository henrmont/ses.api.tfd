...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('patient_requests', function (Blueprint $table) {
            ...
            $table->foreignId('payment_professional_id')->nullable();
            $table->foreignId('owner_professional_id');
            $table->foreignId('hospital_unity_id');
            $table->string('type');
            ...
            $table->string('back_to_accountability')->nullable();
            $table->string('back_to_payment')->nullable();
            ...
            $table->foreignId('archive_professional_id')->nullable();
            $table->boolean('is_travel_finished')->default(false);
            $table->boolean('is_accountability_finished')->default(false);
            $table->boolean('is_payment_finished')->default(false);
            $table->softDeletes();
            $table->timestamps();
        });
    }

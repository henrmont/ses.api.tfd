...
class AccountabilityController extends Controller
{
    ...
    public function finishPatientRequestAccountability(PatientRequest $patient_request, AccountabilityService $accountabilityService)
    {
        $this->authorize('tfd/ajuda de custo atualizar');
        return $accountabilityService->finishPatientRequestAccountability($patient_request);  
    }
